...
exclusive to the ai4eosc_exercises package. You can use the `config.py`
...
"""
# Do NOT import anything from `api` or `ai4eosc_exercises` packages here.
...
MODELS_PATH = os.getenv("AI4EOSC_EXERCISES_MODELS_PATH", default=BASE_PATH / "models")
MODELS_PATH = Path(MODELS_PATH)
# Path definition for data folder
DATA_PATH = os.getenv("AI4EOSC_EXERCISES_DATA_PATH", default=BASE_PATH / "data")
DATA_PATH = Path(DATA_PATH)

# configure logging:
# logging level across various modules can be setup via USER_LOG_LEVEL,
# options: DEBUG, INFO(default), WARNING, ERROR, CRITICAL
ENV_LOG_LEVEL = os.getenv("AI4EOSC_EXERCISES_LOG_LEVEL", "INFO")
LOG_LEVEL = getattr(logging, ENV_LOG_LEVEL.upper())

# EXAMPLE on how to load environment variables
PARAMETER_INT = os.getenv("AI4EOSC_EXERCISES_PARAMETER_INT", default="10")
DATA_SIZE = os.getenv("AI4EOSC_EXERCISES_DATA_SIZE", default="10")
